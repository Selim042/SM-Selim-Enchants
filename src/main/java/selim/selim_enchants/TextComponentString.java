...
public class TextComponentString extends TextComponentBase {
	...
	/**
	 * Gets the text value of this component. This is used to access the
	 * {@link #text} property, and only should be used when dealing specifically
	 ...
	 * without any formatting codes. For example, this is the raw text in a
	 * {@link TextComponentString}, but it's the translated text for a
